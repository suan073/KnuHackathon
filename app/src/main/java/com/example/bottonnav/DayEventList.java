...
public class DayEventList {
    ...
    public DayEventList(String userID, int eventNum, String eventName, String eventType, int eResStartMonth, int eResEndMonth, int eResStartDay, int eResEndDay, int eProStartMonth, int eProEndMonth, int eProStartDay, int eProEndDay, String eventMajor, int eventGrade, String eventDetail, String eventLink) {
        this.userID = userID;
        this.eventNum = eventNum;
        this.eventName = eventName;
        this.eventType = eventType;
